        ...
        VStack(alignment: .leading, spacing: 10) {
            ...
            HStack(spacing: 14) {
                Image(systemName: "applewatch")
                    .font(.title2)
                    .foregroundStyle(pairingService.appleWatchConnected ? .green : .white)
                    .frame(width: 36)
            ...
            HStack(spacing: 14) {
                Image(systemName: "figure.walk.circle")
                    .font(.title2)
                    .foregroundStyle(pairingService.fitbitConnected ? .green : .white)
                    .frame(width: 36)
                ...
                VStack(alignment: .leading, spacing: 2) {
                    Text("Fitbit")
                        ...
                        .fontWeight(.semibold)
                        .foregroundStyle(.white)
                    Text(pairingService.fitbitConnected ? "Connected — syncing heart rate" : "Sign in with your Google Account (Fitbit)")
                        .font(.caption2)
                        .foregroundStyle(.secondary)
