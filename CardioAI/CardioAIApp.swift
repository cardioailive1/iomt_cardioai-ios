...
struct CardioAIApp: App {
    ...
    init() {
        // Brand-wide appearance ported from cardioai-ios (indigo large titles).
        AppTheme.apply()
    }
    ...
    var body: some Scene {
        WindowGroup {
            RootView()
                ...
                .task {
                    // Validate config and restore session on cold launch
                    AppConfiguration.shared.validateOrLog()
